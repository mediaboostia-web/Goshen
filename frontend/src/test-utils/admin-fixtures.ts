// Wave 0 test fixtures for Phase 3 (Admin / Visibility).
//
...
//     pre-shaped User/OutboxEvent/EmailJob the test then wires
//     into `prismaMock.user.findFirst.mockResolvedValue(...)` etc.
//   - `mock*` factories return Vitest stubs (Redis client) wired to
//     common scenarios (populated rate-limit bucket).
//
...
import type { User, OutboxEvent, EmailJob, Prisma } from '@prisma/client';
